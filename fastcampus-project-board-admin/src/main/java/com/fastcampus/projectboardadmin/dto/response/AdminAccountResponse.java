...
public record AdminAccountResponse(
    ...
    public static AdminAccountResponse of(String userId, String roleTypes, String email, String nickname, String memo, LocalDateTime createDate, String createUser) {
        return new AdminAccountResponse(userId, roleTypes, email, nickname, memo, createDate, createUser);
    }
